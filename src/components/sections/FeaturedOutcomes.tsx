...
export function FeaturedOutcomes() {
  ...
  return (
    <section id="work" className="border-y border-white/5 py-20 md:py-28">
      <Container>
        <div ref={ref}>
          <SectionTitle
            eyebrow="Proof"
          ...
          <div className="grid gap-4 md:grid-cols-3">
            {caseStudies.map((study) => (
              <article key={study.slug} className="outcome-card rounded-2xl bg-white/5 p-7 ring-1 ring-white/10 transition hover:-translate-y-1 hover:ring-emerald-300/40">
