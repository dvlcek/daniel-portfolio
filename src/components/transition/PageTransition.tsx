    ...
    <>
      ...
      >
        ...
        <div
          ...
          style={{
            opacity: phase === "logo-in" || phase === "logo-hold" ? 1 : 0,
            transform:
        ...
        >
          <div className="relative">
            ...
            <Image
              ...
              height={200}
              priority
              className="relative z-10 drop-shadow-[0_0_30px_rgba(29,78,216,0.6)] rounded-xl"
            />
          </div>
      ...
      <div
        ...
        style={{
          background: "#000814",
          transform:
            phase === "cover" || phase === "logo-in" || phase === "logo-hold" || phase === "logo-out"
              ? "translateY(0%)"
              : "translateY(100%)",
          transition:
            phase === "cover"
